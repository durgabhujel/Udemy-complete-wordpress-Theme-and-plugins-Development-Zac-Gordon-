...
// action hooks is used to run your own code when certain events take place in the wordpress
...
function phpforwp_read_more_link( $excerpt ) {
  ...
  $extended_excerpt .='<a herf="'. get_permalink() .'">';
...
// filter hook is used to change or modify how to content is displayed on a page or save to database
